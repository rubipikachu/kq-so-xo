...
<head>
    ...
    <title>Bảng đặc biệt tuần theo tổng</title>
...
<div style="width: 1260px;" align="center">
                ...
                <div id="right_content">
					...
					<div id="title_header" style="text-align: left; padding-left: 5px; padding-right: 5px;">
							<div class="title_hearder link_ione a_left pl5 f_bold">Bảng đặc biệt tuần xổ số Miền Bắc</div>
						</div>
              ...
              Chọn tỉnh:
                ...
                <td>                              
							  ...
							  <tr>
								<td class="f_arial f_size12" bgcolor="#ffffff">				
																		<div>&nbsp;</div>
									<div style="text-align: center; font-weight: bold;">BẢNG THỐNG KÊ GIẢI ĐẶC BIỆT THEO TUẦN CỦA KẾT QUẢ XỔ SỐ MIỀN BẮC<br></div>
									<div>&nbsp;</div>
									...
									<table id="table1" style="border-collapse: collapse;" border="0" cellspacing="0" width="100%">
										...
										<tr>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Thứ hai</b></font></td>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Thứ ba</b></font></td>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Thứ tư</b></font></td>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Thứ năm</b></font></td>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Thứ sáu</b></font></td>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Thứ bảy</b></font></td>
											<td align="center" bgcolor="#000080" height="25"><font color="#ffffff"><b>Chủ Nhật</b></font></td>
										</tr>
                                        <?php                                                   
                ...
                foreach ($arrKQ as $i){
                    ...
                    $so1 = substr($i['g0'],strlen($i['g0'])-2,1);
                    $so2 = substr($i['g0'],strlen($i['g0'])-1,1);
                    $tong = ($so1 + $so2) % 10;
                    ...
                    if($dem == 1){ 
                        ...
                        $dongTong .= "<td align='center'><b>{$tong}</b></td>"; 
                        if($thu == 8){
                            $dong .= "</tr>";
                            $dongNgay .= "</tr>";
                            $dongTong .= "</tr>";
