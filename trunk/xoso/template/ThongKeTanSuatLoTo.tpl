...
<div id="right_content">
                    ...
                    <div style="padding-left: 10px; padding-top: 6px;">                    		
						...
						<div id="title_header" style="text-align: left; padding-left: 5px; padding-right: 5px;">
							<div class="title_hearder link_ione a_left pl5 f_bold">Th?ng kê t?n su?t loto c?a x? s? mi?n B?c</div>
					  </div>
						<table align="center" bgcolor="#d7d7d7" border="0" cellpadding="0" cellspacing="0" width="740">
							<tbody><tr>
							  <td bgcolor="#ffecec">
								<div id="thanhcuon" class="f_verdana f_size12 c_blue f_bold" style="cursor: pointer; padding: 5px 0px 5px 5px; background-color: rgb(255, 236, 236); line-height: 20px; text-align: left;">B?n click vào dây xem hu?ng d?n s? d?ng Th?ng Kê T?n Su?t Loto</div>
                          <div id="huongdandangkyvip" style="border: 1px solid rgb(255, 153, 0); padding: 10px; font-family: Verdana,Arial; font-size: 12px; background-color: rgb(255, 236, 236); line-height: 20px; display: none;" align="left">
										B?ng th?ng kê  loto này giúp b?n theo dõi du?c t?n su?t xu?t 
hi?n c?a các c?p s? loto m?t cách chi ti?t nh?t. D?a trên các thông kê 
dó b?n có th? d? doán c?p s? nào s?p ra và ra trong kho?ng nào?.<br>
							Ð? xem th?ng kê trong giai do?n nào b?n c?n ch?n  <span style="color: rgb(255, 102, 0); font-weight: bold;">T? ngày</span> và <span style="color: rgb(255, 102, 0); font-weight: bold;">Ð?n ngày</span> sao cho kho?ng cách ngày gi?a chúng không quá gi?i h?n ngày du?c xem, sau dó b?m chu?t vào nút <span style="color: rgb(255, 102, 0); font-weight: bold;">Xem k?t qu?</span> d? xem.
                            <br>
                            <br>
                                         ...
                                         <tr>
                                          ...
                                          <tr>
                                            <td colspan="2" class="f_arial f_size12" height="60"><input name="button" id="button" value="&nbsp; &nbsp; Xem k?t qu? &nbsp; &nbsp;" type="submit">
                                              ...
                                              <em>D? li?u du?c tra c?u t? 01/01/2005 d?n nay.<br><strong>Ch? có <span style="color: red; font-weight: bold;">VIP</span> m?i xem du?c th?ng kê trong <span style="color: red; font-weight: bold;">100</span> ngày</strong></em>
                                            </td>
                                          </tr>
                                        </tbody></table>
							...
							<tr>
								<td bgcolor="#ffffff">          
									<div id="full_screen" class="smallscreen">
                                    	<div style="background-image: url(&quot;images/bg.gif&quot;);"><div onclick="to_full()" id="click_to_full" align="left">Xem toàn màn hình</div></div>
									    <table style="border-collapse: collapse;" border="1" bordercolor="#cccccc" cellpadding="0" cellspacing="0" width="3130">
	<tbody><tr>

                                                            <td class="pt_header" align="center" bgcolor="#d6d6d6" width="130">Ngày\C?p s?</td>
